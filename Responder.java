...
public class Responder {
    ...
    public String generateResponse(HashSet<String> words) {
        ...
        // None recognized: return a random default response.
        return pickDefaultResponse();
    }

    /**
     * Provide access to the response map (used by WordCounter filtering).
     *
     * @return the response map of known words and their replies
     */
    ...
    private void fillResponseMap() {
        ...
        responseMap.put("installation", 
            "The installation is really quite straightforward. We have tons of "
          + "wizards that do all the work for you. Have you read the installation "
          + "instructions?");
        responseMap.put("memory", 
            "If you read the system requirements carefully, you will see that the "
          + "specified memory requirements are 1.5 gigabytes. You really should "
